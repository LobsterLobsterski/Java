...
public class Main {
    ...
    static String nazwa1="F:\\Kody\\Java\\projektZaliczeniowy\\", nazwa2;
        ...
        while(true){
            ...
            switch (menu){
                ...
                case 4://nadpisz pracowników
                    try {
                        FileWriter writer = new FileWriter(nazwa1+"pracownicy.txt", false);
                ...
                case 5://dodaj zam
                    ...
                    try {
                        FileWriter writer = new FileWriter(nazwa1+"zamowienia.txt", true);
                ...
                case 8://nadpisz zam
                    try {
                        FileWriter writer = new FileWriter(nazwa1+"zamowienia.txt", false);
                        for (Zamowienie z : zam) {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        String nazwa=nazwa1+"pracownicy.txt";
        String linia;
        String tab[]=null;
