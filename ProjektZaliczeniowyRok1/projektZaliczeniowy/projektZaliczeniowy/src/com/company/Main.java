...
public class Main {
        ...
        while(true){
            ...
            switch (menu){
                ...
                case 2://usuń
                    if (pozUprawnien==2){
                        ...
                        if (temp!=null) {
                            ...
                            System.out.println("Usunąć? true/false");
                ...
                case 4://nadpisz pracowników
                    try {
                        FileWriter writer = new FileWriter("H:\\ProgramowaniaJava\\Zadania\\projektZaliczeniowy\\pracownicy.txt", false);
                ...
                case 5://dodaj zam
                    ...
                    try {
                        FileWriter writer = new FileWriter("H:\\ProgramowaniaJava\\Zadania\\projektZaliczeniowy\\zamowienia.txt", true);
                ...
                case 8://nadpisz zam
                    try {
                        FileWriter writer = new FileWriter("H:\\ProgramowaniaJava\\Zadania\\projektZaliczeniowy\\zamowienia.txt", false);
                        for (Zamowienie z : zam) {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        String nazwa="H:\\ProgramowaniaJava\\Zadania\\projektZaliczeniowy\\pracownicy.txt";
        String linia;
        String tab[]=null;
        ...
        nazwa="H:\\ProgramowaniaJava\\Zadania\\projektZaliczeniowy\\zamowienia.txt";
